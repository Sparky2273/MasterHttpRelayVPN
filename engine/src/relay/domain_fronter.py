                ...
                for _t in list(self._h2_pool):
                    if not _t.is_connected:
                        try:
                            ...
                            # The H2Transport's built-in idle keepalive
                            # (_send_idle_keepalive) fires automatically
                            # when streams go idle on the fresh connection.
                        except Exception as exc:
