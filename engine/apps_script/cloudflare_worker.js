...
//
// ⚠️  IMPORTANT: Change PSK below to match exit_node.psk in your config.json
//     If this doesn't match, every proxy request will return 401 Unauthorized.
//     Example: if config.json has "psk": "mysecret123", set PSK = "mysecret123"
